...
/*************************************************
  宏定义
*************************************************/
#define SOFTWARE_VERSION	"XJ atmel_powerd V10.1.0"
#define DRIVER_NAME 		"power_detect"

#define MAJOR_DEVICE	108
...
/*************************************************
  结构类型定义
*************************************************/
struct atmel_powerd_t{
	char	name[20];
	int		irq;
	u8		io_level;
	u8		mode;			//监控模式，1上电，2掉电，3掉上电
	u32		ioaddr;			//存储掉点检测要监控的io地址
	u16		timeout;			//睡眠超时
	atomic_t 			opened;

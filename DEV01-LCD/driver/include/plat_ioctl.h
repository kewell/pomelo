...
#define CMD_BEEP                    _IO   (PLATDRV_MAGIC, 0x80)
#define CMD_LED2                    _IO   (PLATDRV_MAGIC, 0x81)
#define CMD_LED3                    _IO   (PLATDRV_MAGIC, 0x82)
#define CMD_LED4                    _IO   (PLATDRV_MAGIC, 0x83)
#define CMD_BL                      _IO   (PLATDRV_MAGIC, 0x84)
#define CMD_RELAY_CTRL              _IO   (PLATDRV_MAGIC, 0x85)
#define CMD_WATCHDOG                _IO   (PLATDRV_MAGIC, 0x86)

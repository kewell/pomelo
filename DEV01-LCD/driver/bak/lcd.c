 ...
 *
 *       Filename:  lcd.c
 *    Description:  SEGMENT SEG112~SEG271
 *                 
...
void words(U8 x,U8 y,U8 type,U8 *p)
{
...
void character(void)
{
    ...
    //words_all(0, 10, 80, 160, F_80);
    write_cmd(MAPPING_CTL | 0x00);
    words_all(0, 10, 16, 32, F_16);sleep(1);
    write_cmd(MAPPING_CTL | 0x02);
    words_all(0, 10, 16, 32, F_16);sleep(1);
    write_cmd(MAPPING_CTL | 0x04);
    words_all(0, 10, 16, 32, F_16);
//    write_cmd(MAPPING_CTL | 0x06);
//    words_all(0, 10, 16, 32, F_16);
#if 0
...
int main (void)
{
    ...
    GUI_FillSCR(0x00);row(10,0xff);GUI_CopyRAMToLCD(disp_area);
    sleep(2);
    GUI_FillSCR(0x00);row(10,0x00);GUI_CopyRAMToLCD(disp_area);
#endif

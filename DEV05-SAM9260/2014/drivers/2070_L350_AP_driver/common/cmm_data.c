...
#ifdef CONFIG_AP_SUPPORT
		IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
		eQIdx = 3;	// 4 ACs + HCCA, start from 0.
//		eQIdx = 4;	// 4 ACs + HCCA, start from 0.
#endif // CONFIG_AP_SUPPORT //
	}
	else
	{
	...
	IN PUCHAR pAddr) 
{
	...
	RT28XX_AP_UPDATE_CAPABILITY_AND_ERPIE(pAd);  // edit by johnli, fix "in_interrupt" error when call "MacTableDeleteEntry" in Rx tasklet

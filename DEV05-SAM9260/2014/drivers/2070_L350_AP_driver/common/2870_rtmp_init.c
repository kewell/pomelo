...
//	RTMP_TX_RING	*pTxRing;
	...
	//	for(acidx=0; acidx<NUM_OF_TX_RING; acidx++) //PS packets use HCCA queue when dequeue from PS unicast queue (WiFi WPA2 MA9_DT1 for Marvell B STA)
		for(acidx=0; acidx<4; acidx++) //PS packets use HCCA queue when dequeue from PS unicast queue (WiFi WPA2 MA9_DT1 for Marvell B STA)
